from tfdat.utils.classes import get_names

# from asone.utils.download import download_weights
from tfdat.utils.colors import compute_color_for_labels
...
from tfdat.utils.draw import draw_boxes, draw_ui_box
from tfdat.utils.draw import draw_text
